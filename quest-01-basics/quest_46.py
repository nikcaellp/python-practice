...
if opc ==1:
    print(f"Valor com %10 de desconto: $RS{preco-(preco*10)/100}")
elif opc ==2:
    print(f"Valor com %5 de desconto: $RS{preco-(preco*5)/100}")
elif opc ==3:
    print(f"Valor normal: $RS{preco}")
elif opc ==4:
    print(f"Valor com %20 de juros: $RS{preco+((preco*20)/100)}")